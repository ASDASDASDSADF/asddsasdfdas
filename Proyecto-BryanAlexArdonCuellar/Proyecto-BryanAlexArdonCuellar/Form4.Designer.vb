...
Partial Class Form4
    ...
    Private Sub InitializeComponent()
        ...
        Label2.TabIndex = 1
        Label2.Text = "Act 1 = 15%" & vbCrLf & "Act 2 = 35%" & vbCrLf & "Laboratorio = 10%" & vbCrLf & "TareaEx 10%" & vbCrLf & "ExamenFinal = 30%"
        ' 
        ' Label1
        ' 
        ...
        Label1.TabIndex = 0
        Label1.Text = "Calculo de notas de Lenguaje"
        ' 
        ' Panel2
        ' 
