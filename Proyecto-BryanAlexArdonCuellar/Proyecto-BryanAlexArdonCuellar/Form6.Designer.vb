...
Partial Class Form6
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Location = New Point(604, 31)
        Label2.Name = "Label2"
        Label2.Size = New Size(159, 63)
        Label2.TabIndex = 1
        Label2.Text = "Act 1 = 35%" & vbCrLf & "Act 2 = 35%" & vbCrLf & "ExamenFinal = 30%"
        ' 
        ' Label1
        ' 
        ...
        Label1.TabIndex = 0
        Label1.Text = "Calculo de notas de Sociales"
        ' 
        ' Panel2
        ' 
        ...
        ' TextBox7
        ' 
        TextBox7.Location = New Point(85, 118)
        ...
        Label12.Location = New Point(0, 123)
        ...
        ' Panel4
        ' 
        Panel4.BackColor = Color.FromArgb(CByte(192), CByte(192), CByte(255))
        ...
        DataGridView1.Columns.AddRange(New DataGridViewColumn() {Column1, Column2, Column3, Column4, Column6, Column7, Column8})
