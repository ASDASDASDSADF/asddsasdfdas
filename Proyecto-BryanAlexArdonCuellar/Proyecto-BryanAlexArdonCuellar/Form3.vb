...
Public Class Form3
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            result = act1 * 0.25 + act1 * 0.25 + act3 * 0.15 + tareaex * 0.05 + exf * 0.3
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        archivo = datos.createtextfile("Septimo/Matematicas/Imprimir")
        archivo.writeline("                                                INSTITUTO NACIONAL THOMAS JEFFERSON")
        archivo.writeline("              ASIGNATURA: MATEMATICAS                                         SECCIÓN: SEPTIMO GRADO")
        ...
        Process.Start("notepad.exe", "Septimo/Matematicas/Imprimir")
        archivo.close()
