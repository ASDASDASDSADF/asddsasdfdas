...
Partial Class Form5
    ...
    Private Sub InitializeComponent()
        ...
        Label2.TabIndex = 1
        Label2.Text = "Act 1 = 10%" & vbCrLf & "Act 2 = 10%" & vbCrLf & "Act 3 = 10%" & vbCrLf & "Laboratorio = 20%" & vbCrLf & "ExamenFinal = 50%"
        ' 
        ' Label1
        ' 
        ...
        Label1.TabIndex = 0
        Label1.Text = "Calculo de notas de Ciencias" & vbCrLf
        ' 
        ' Panel2
        ' 
        ...
        ' Panel3
        ' 
        Panel3.BackColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        ...
        ' Panel4
        ' 
        Panel4.BackColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
